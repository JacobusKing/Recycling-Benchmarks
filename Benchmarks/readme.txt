...
==============================================================================================
                    PVRPTW Instances of Pirkwieser et al. (2009)

WARNING: The distances of Pirkwieser and Raidl [41] instances have been truncated to the first digit by previous authors.
This is a specificity of this instance set, in all the other cases, the distances should be computed with double precision.

The solution format is identical to the one of http://neumann.hec.ca/chairedistributique/data/:
===============================================================================================
